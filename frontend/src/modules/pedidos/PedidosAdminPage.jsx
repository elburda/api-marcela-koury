...
import { getPedidosPorVendedor, deletePedido } from '../../services/pedidosService';
...
//     // Mostrar toast si viene desde el login
//     useEffect(() => {
//         if (location.state?.toast) {
//             setToast(location.state.toast);
//             setTimeout(() => setToast(null), 4000);
...
//         alert(`Mostrar JSON de pedido con ID: ${pedidoId}`);
//     };
...
//                     }))
//                 );
//                 setToast({ message: '✅ Pedido eliminado', state: 'success', position: 'top-right' });
//             } catch (err) {
//                 console.error('Error al eliminar pedido:', err);
//                 Swal.fire('Error', 'No se pudo eliminar el pedido', 'error');
//             }
...
//         // Este método puede redirigir o mostrar detalle
//         console.log("Pedido a ver:", pedido);
//     };
